/* Phase 8 features ticket 33 (ADR-0036): the 23 hub-row route bases moved
   ...
   Ticket 09 (ADR-0084) moves the medication module the same way: regimen,
   labs and the hormone curve get their own `/care/*` address, the stock
   editor's old screen and the deleted exposure screen both redirect to
   `/care` itself rather than to a stub for something that no longer
