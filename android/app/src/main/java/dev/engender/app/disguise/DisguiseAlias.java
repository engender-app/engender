...
public final class DisguiseAlias {
    ...
    public static final String DEFAULT = "dev.engender.app.disguise.LauncherDefault";
    public static final String DISGUISED = "dev.engender.app.disguise.LauncherDisguised";
