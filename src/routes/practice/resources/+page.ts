/* Phase 11 all-four-doors ticket 21 (ADR-0036, ADR-0072): the Practice
   ...
   instead. This screen's door is Support - the address does not move
   with it, so anyone who bookmarked or was sent this link keeps it
   working. */
import { redirect } from '@sveltejs/kit';

export function load() {
  redirect(307, '/support/resources');
}
