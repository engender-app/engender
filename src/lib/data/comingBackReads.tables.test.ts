...
test('a table the registry adds to one of the five reads reaches WAITING_TABLES unedited', async () => {
...
test('WAITING_TABLES has no duplicate and no table of its own', async () => {
  vi.doMock('./live/writes', () => ({
