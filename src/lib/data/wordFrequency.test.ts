...
describe('distinctiveWords', () => {
  ...
  it('drops a word spread evenly across the journal, however often it is written', async () => {
    const { distinctiveWords } = await import('./wordFrequency');
  ...
  it('weights a word by how much more it is written here than across the journal', async () => {
    const { distinctiveWords } = await import('./wordFrequency');
  ...
  it('carries each words own count, which is what the stretch actually holds', async () => {
    const { distinctiveWords } = await import('./wordFrequency');
  ...
  it('breaks a tie alphabetically, so two runs over one journal agree', async () => {
    const { distinctiveWords } = await import('./wordFrequency');
  ...
  it('honours the ignore list the count already honours', async () => {
    const { distinctiveWords } = await import('./wordFrequency');
  ...
  it('says nothing at all where the stretch is the whole journal', async () => {
    const { distinctiveWords } = await import('./wordFrequency');
  ...
  it('holds an empty stretch and an empty journal without dividing by nothing', async () => {
    const { distinctiveWords } = await import('./wordFrequency');
