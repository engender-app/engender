...
test('thirteen rows can report a reading and eight never can', () => {
  ...
  // off with the screen it opened. Thirteen since ticket 13 folded
  // `side-effects` into `effects` rather than giving it a row of its own -
  // one fewer reading row, and the written eight are untouched by it.
