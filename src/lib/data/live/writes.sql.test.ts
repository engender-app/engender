...
beforeAll(async () => {
  ...
  await driveRead('entries', 'entriesWithTag', () => journal.entries.entriesWithTag(tag2.id, 0, 20000, 10));
  ...
  await driveRead('doses', 'hasDosesBefore', () => journal.doses.hasDosesBefore(20000));
