...
function adaptiveForeground(stripes) {
  ...
  return (
    ...
    + `        <clip-path android:pathData="${roundedRectPath(0, 0, MARK_R, MARK_TILE_RADIUS)}" />\n`
    + `        <path\n`
    + `            android:pathData="${roundedRectPath(0, 0, MARK_R, MARK_TILE_RADIUS)}"\n`
    + `            android:fillColor="${MARK_TILE}" />\n`
    + `${rings}\n`
    + `        <path\n`
    + `            android:pathData="${roundedRectPath(inset, inset, MARK_R - MARK_SEAM, MARK_TILE_RADIUS - inset)}"\n`
